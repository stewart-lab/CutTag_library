...
sampleList = c("H3K27me3_25", "H3K36me3_25")
...
for(hist in sampleList){
  alignRes = read.table(paste0(projPath, "/alignment_25/sam/bowtie2_summary/", hist, "_bowtie2.txt"), header = FALSE, fill = TRUE)
...
spikeAlign = c()
for(hist in sampleList){
  spikeRes = read.table(paste0(projPath, "/alignment_25/sam/bowtie2_summary/", hist, "_bowtie2_spikeIn.txt"), header = FALSE, fill = TRUE)
...
pdf(file= "alignment_summary.pdf")
